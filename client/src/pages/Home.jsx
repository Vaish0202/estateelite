...
export default function Home() {
  ...
  const [rentLsitings, setRentLsitings] = useState([]);
    ...
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          ...
          <Link className="text-xs sm:text-sm text-blue-800 font-bold hover:underline-offset-1" to={"/search"}>
            Let's get started..
          </Link>
      ...
      <div className="max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10">
        ...
        {
          rentLsitings && rentLsitings.length > 0 && (
            <div className="">
              <div className="my-3">
